...
//(1) Length
document.getElementById("ex11-3-1").innerHTML = "lorem = " + lorem.length + "<br>" + "eng_alphabet = " 
+ eng_alphabet.length + "<br>" + "thai_alphabet = " + thai_alphabet.length;

//(2) Position IndexOf() start 0,1,2,...,n
document.getElementById("ex11-3-2").innerHTML = "\"Ipsum\" position = " + lorem.indexOf("Ipsum") 
+ "<br>" + "\"N\" position = " + eng_alphabet.indexOf("N") + "<br>" + "\"ช\" position = " 
+ thai_alphabet.indexOf("ช");
